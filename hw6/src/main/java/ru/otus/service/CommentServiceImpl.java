...
import ru.otus.exception.service.DeleteCommentException;
import ru.otus.exception.service.FindAllCommentByIdException;
import ru.otus.exception.service.GetCommentByIdException;
import ru.otus.exception.service.SaveCommentException;
...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentBook getCommentById(Long id) {
        return commentBookRepository.getById(id).orElseThrow(() -> new GetCommentByIdException(id, "Not found comment by Id"));
    }
